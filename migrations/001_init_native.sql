...
-- pgvector non disponibile su Windows nativo: embedding come BYTEA
...
CREATE TABLE document_chunks (
    ...
    embedding       BYTEA                        ,                 -- dimensione da adattare al modello embedding scelto
    metadata        JSONB DEFAULT '{}'::jsonb,    -- es. {"page": 12, "section": "Networking"}
    created_at      TIMESTAMPTZ NOT NULL DEFAULT now()
);

-- ivfflat index omesso (richiede pgvector)
